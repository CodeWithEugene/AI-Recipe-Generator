...
const IngredientInput: React.FC<IngredientInputProps> = ({ ingredients, setIngredients, onSubmit, isLoading }) => {
  ...
  return (
    <div className="w-full max-w-4xl bg-white/90 backdrop-blur-sm p-8 md:p-10 rounded-3xl shadow-2xl border border-orange-100 relative overflow-hidden animate-bounce-in hover-lift">
            ...
            <div>
              ...
              <div className="relative">
                <textarea
                  ...
                  className="w-full h-20 p-6 border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-orange-200 focus:border-orange-400 transition-all duration-300 ease-in-out resize-none text-lg placeholder-gray-400 bg-white/80 backdrop-blur-sm shadow-inner"
                  disabled={isLoading}
                />
            ...
            >
              {isLoading ? (
                <>
                  ...
                  <span className="text-lg">Crafting Your Recipe...</span>
                </>
              ) : (
                <>
                  ...
                  <span className="text-lg">Create Recipe</span>
                </>
              )}
            </button>
          </div>
